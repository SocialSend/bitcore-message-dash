...
For more information refer to the [socialsendcore-message](https://github.com/SocialSend/socialsendcore-message) github repo.
...
```bash
npm install SocialSend/socialsendcore-message --save
```

For client-side projects:

```bash
bower install socialsendcore-message --save
```
